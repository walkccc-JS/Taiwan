                ...
                <div className="media-content">
                  <div className="content">
                    <p>
                      ...
                      <a href={'/' + post.authorId}>@{post.authorId}</a>
                      <br />
                      {user && user.message ? (
                      ...
                      <span>
                        <time
                          dateTime={moment(post.createdAt.toDate()).calendar()}
                        >
                      ...
                      {post.editedAt ? (
                        <span>
                          <time
                            dateTime={moment(post.editedAt.toDate()).calendar()}
                          >
                            {' '}
                            · {moment(post.editedAt.toDate()).calendar()}
                          </time>
                        </span>
                      ) : null}
                    </p>
